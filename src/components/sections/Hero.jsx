...
export function Hero() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(".hero-eyebrow", { opacity: 0, y: 10 }, { opacity: 1, y: 0, duration: 0.45 })
        .fromTo(".hero-headline", { opacity: 0, y: 28 }, { opacity: 1, y: 0, duration: 0.65 }, "-=0.15")
        .fromTo(".hero-bio", { opacity: 0, y: 16 }, { opacity: 1, y: 0, duration: 0.55 }, "-=0.3")
        .fromTo(".hero-badge", { opacity: 0, y: 10, scale: 0.97 }, { opacity: 1, y: 0, scale: 1, duration: 0.4 }, "-=0.2")
